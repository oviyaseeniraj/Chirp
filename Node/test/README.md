...
| :--- | :--- | :--- |
| `capture_data.py` | CLI utility for capturing radar data (raw ADC + processed RDM) and converting to .mat. | `python3 capture_data.py --capture --frames 100 --output data` <br> `python3 capture_data.py --convert --input-dir data/rdm --output-file data.mat` |
